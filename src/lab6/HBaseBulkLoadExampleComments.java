...
public class HBaseBulkLoadExampleComments extends Configured implements Tool {
	...
	static class HBaseVoteMapper extends Mapper<LongWritable, Text, ImmutableBytesWritable, Put> {
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			...
			Comments vote = new Comments(value.toString());
			...
			put.addColumn(Bytes.toBytes("commentInfo"), Bytes.toBytes("uid"), Bytes.toBytes(vote.getScore()));
			put.addColumn(Bytes.toBytes("commentInfo"), Bytes.toBytes("Score"), Bytes.toBytes(vote.getText()));
			put.addColumn(Bytes.toBytes("userInfo"), Bytes.toBytes("UserId"), Bytes.toBytes(vote.getUserId()));
	...
	public int run(String[] args) throws Exception {
		...
		FileInputFormat.addInputPath(job, new Path("hdfs://localhost:9000/user/comp9313/Comments"));
	...
	public static void main(String[] args) throws Exception {
		...
		int exitCode = ToolRunner.run(HBaseConfiguration.create(), new HBaseBulkLoadExampleComments(), args);
